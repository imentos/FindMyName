...
class ViewController: UIViewController {
    ...
    private func showUsernameAlert() {
        let alert = UIAlertController(title: "Your name", message: "Enter your name to find", preferredStyle: UIAlertController.Style.alert)
    ...
    func calculateRegionOfInterest() {
        guard bufferAspectRatio != nil else { return }
